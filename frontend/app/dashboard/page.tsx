  ...
  if (loading) {
    return (
      <div className="flex flex-col w-full min-h-[100dvh] bg-gradient-to-b from-[#b5d5e2] to-[#7198ad] text-[#13202e] p-6 pt-28 overflow-y-auto pb-24">
        ...
        <div className="bg-[#f2ead6] border-4 border-[#13202e] shadow-[8px_8px_0px_#13202e] rounded-3xl p-6 flex flex-col justify-center items-center text-center animate-pulse h-48 mb-6">
